...
var MmdbServiceService = /** @class */ (function () {
    function MmdbServiceService(http) {
        this.http = http;
    ...
    MmdbServiceService.prototype.searchMovie = function (searchQuery) {
        throw new Error('Method not implemented.');
    };
    MmdbServiceService.prototype.getAllMovies = function () {
    ...
    MmdbServiceService.prototype.searchMovies = function (searchQuery) {
        var url = this.baseUrl + "/search/movie?api_key=" + this.apiKey + "&language=en-US&query=" + searchQuery + "&page=1&include_adult=false";
        return this.http.get(url);
    };
    MmdbServiceService.prototype.getMovieDetails = function (movieId) {
        var url = this.baseUrl + "/movie/" + movieId + "?api_key=" + this.apiKey + "&language=en-US";
        return this.http.get(url);
        // return this.http.get(`https://api.themoviedb.org/3/${movieId}/?api_key=5c06fed2cdf4dfcdab132d9e67c1c2e7&language=en-US`)
    };
    MmdbServiceService.ctorParameters = function () { return [
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(mmdbSer, router) {
    ...
    HomeComponent.prototype.allMovies = function () {
        var _this = this;
        this.mmdbSer.getAllMovies().subscribe(function (res) {
            if (res.results) {
                _this.movieslist = res.results.map(function (movie) { return ({
                    poster_path: _this.prefix + movie.poster_path,
                    title: movie.title,
                    vote_average: movie.vote_average,
                    id: movie.id,
                    overview: movie.overview,
                }); });
                console.log("movielist" + _this.movieslist);
            }
        });
    };
    HomeComponent.prototype.serachMovies = function () {
        var _this = this;
        this.mmdbSer.searchMovies(this.filterString).subscribe(function (res) {
            if (res.results) {
                _this.serachlist = res.results.map(function (movie) { return ({
                    poster_path: _this.prefix + movie.poster_path,
                    title: movie.title,
                    vote_average: movie.vote_average,
                    id: movie.id,
                ...
                console.log("serchlist" + _this.serachlist);
            }
        });
    };
    HomeComponent.prototype.navigate = function (movie) {
        this.mmdbSer.movies.next(movie.id);
        this.router.navigate(['/moviedetails', movie.id]);
        console.log(movie.id);
    };
    HomeComponent.prototype.callme = function () {
        // this.allMovies()
        this.serachMovies();
    };
...
var MovieDetailsComponent = /** @class */ (function () {
    function MovieDetailsComponent(movieService, route) {
        ...
        this.route.params.subscribe(function (res) {
            _this.loadmoviedetails(res.id);
        });
    }
    MovieDetailsComponent.prototype.loadmoviedetails = function (id) {
        var _this = this;
    ...
    MovieDetailsComponent.prototype.getFullPosterPath = function (posterPath) {
        var prefix = 'https://image.tmdb.org/t/p/w1280';
        if (posterPath) {
...
var SearchComponent = /** @class */ (function () {
    ...
    SearchComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.movieService.search.subscribe(function (res) {
            _this.searchMovie = res;
        });
    };
